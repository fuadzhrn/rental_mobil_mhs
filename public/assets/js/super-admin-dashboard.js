document.addEventListener('DOMContentLoaded', function () {
    var chartElement = document.getElementById('monthlyBookingsChart');
    var dataElement = document.getElementById('monthly-bookings-data');
    ...
    var emptyState = document.querySelector('[data-booking-chart-empty]');
