<aside class="admin-sidebar" aria-label="Sidebar Admin Rental">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('admin-rental.inventories.index') }}" class="{{ request()->routeIs('admin-rental.inventories.*') ? 'is-active' : '' }}">Inventories</a>
        <a href="{{ route('admin-rental.payments.index') }}" class="{{ request()->routeIs('admin-rental.payments.*') ? 'is-active' : '' }}">Data Pembayaran</a>
        <a href="{{ route('admin-rental.bookings.index') }}" class="{{ request()->routeIs('admin-rental.bookings.*') ? 'is-active' : '' }}">Konfirmasi Booking</a>
